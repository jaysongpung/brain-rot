...
export default function Part2Content() {
    return (
        <>
            ...
            <div className="d30"></div>
            <div className="quoteFrom" data-sync-id="p2-quotefrom1">-샘슨 니반스 스웨덴 카롤린스카연구소 신경과학부 연구원</div>
            <div className="d30"></div>
            <div className="d30"></div>
            <div className="d30"></div>
            <div className="paragraph" data-sync-id="p2-para1">소셜미디어 속 저품질 콘텐츠를 과도하게 소비하면 정말로 우리의 지적, 정신적 상태가 저하될까? 그 답을 찾고자 신경과학자, 컴퓨터공학자, 실험심리학자를 만나 &apos;내 뇌가 썩고 있다&apos;는 사람들의 호소를 어떻게 분석할 수 있을지 물어봤다.</div>
            <div className="d30"></div>
            ...
            <div className="d30"></div>
            <div className="quoteFrom" data-sync-id="p2-quotefrom5">-에이미 오벤 영국 케임브리지대 MRC 인지 및 뇌과학 연구소 교수</div>
            <div className="d30"></div>
            <div className="d30"></div>
            <div className="d30"></div>
